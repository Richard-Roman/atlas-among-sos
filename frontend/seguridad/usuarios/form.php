...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => 'http://spring.informaticapp.com:1314/singup',
...
<head>
  <title>Among SOS | Registro usuarios</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active"><i class="ti ti-user"></i>Registrar</li>
              </ol>
